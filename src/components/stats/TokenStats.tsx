    ...
    <div className="border-default relative flex h-full min-h-0 flex-1 flex-col border-r border-white/5">
      <div className="relative">
        <div className={infoClass} aria-hidden={collapsed}>
          <div className="flex w-full min-w-0 overflow-x-auto invisible-scroll items-center gap-4 whitespace-nowrap">
            <TokenIcon
              symbol={symbol}
...
const StatBlock = ({
  ...
  <div className="flex min-w-[110px] flex-col">
    <span className="text-xs uppercase tracking-wide text-[#eee0ff80]">
      {label}
    </span>

...
import {
  getChainVisualMeta,
  type ChainGlyph as ChainGlyphName,
} from "@/lib/chains";
    ...
    <Tooltip.Provider delayDuration={200}>
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          ...
          >
            {meta.glyph ? (
              <ChainGlyph glyph={meta.glyph} />
            ) : (
              <span className="tracking-tight">{meta.abbr}</span>
            )}
          </span>
        </Tooltip.Trigger>
        <Tooltip.Portal>
  ...
  switch (glyph) {
    ...
    case "optimism":
      return (
        ...
        >
          ...
          <path
            d="M9 15V9h1.9c1.1 0 1.8.6 1.8 1.5 0 .9-.7 1.5-1.8 1.5H9Zm5-.2L16 9h1.5l-2 5.8H14Z"
            fill="#0A0A0A"
          />
        </svg>
      );
    ...
    case "zksync":
      return (
        ...
        >
          <path
            d="m6 9 4-4h8l-4 4H6Zm12 6-4 4H6l4-4h8Z"
            fill="currentColor"
            opacity={0.8}
          />
          <path
